...
pub async fn init_system(state: AppState) -> Result<String> {
    ...
    let admin = admin.insert(conn).await?;
    ...
    let super_admin_role = super_admin_role.insert(conn).await?;
    ...
    let admin_role = admin_role.insert(conn).await?;
    ...
    let user_create_permission = user_create_permission.insert(conn).await?;
    ...
    let user_read_permission = user_read_permission.insert(conn).await?;
    ...
    admin_role_map.insert(conn).await?;
